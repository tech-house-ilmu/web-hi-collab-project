<header>
    <nav class="border-b-4 border-primary_light_HI bg-background_HI">
        <div class="max-w-7xl mx-auto flex flex-col p-4 px-6 md:flex-row md:items-center md:justify-between">
            <!-- Logo & Burger -->
            <div class="flex w-full items-center justify-between mt-2 md:w-auto">
            ...
            <div id="navbarNavAltMarkup" class="flex flex-col items-center text-center space-y-2 mt-2 max-h-0 transition-all duration-500 ease-in-out
                md:mt-0 md:flex md:flex-row md:space-y-0 md:gap-4 lg:gap-5 xl:gap-14 md:max-h-none md:overflow-auto">
                ...
                <a class="block w-full nav-link py-2 px-3 font-semibold rounded-lg text-white bg-secondary_HI transition-colors duration-200 hover:text-secondary_HI hover:bg-primary_HI md:w-fit md:hover:bg-primary_HI 
                    {{ Request::is('merch-hi*') ? 'bg-primary_HI md:bg-primary_HI text-secondary_HI' : '' }}"
                href="/merch-hi/">Merch HI</a>
            </div>
        </div>
    </nav>
</header>