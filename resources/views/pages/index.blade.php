...
@section('content')
    ...
    <!-- Start Merchandise HI Section -->
    <section class="merch-hi">
        <div class="flex flex-col justify-center items-center mx-auto gap-6 py-8 px-4 bg-[#FFB200]">
          <h1 class="font-bold py-2 px-4 text-center text-white text-xl bg-primary_HI outline outline-4 outline-secondary_HI rounded-lg md:text-3xl">Merchandise House Ilmu Indonesia</h1>
          <p class="font-semibold text-center text-white">“Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br> Aenean vulputate, odio vel ultrices placerat, purus ipsum pretium mauris, sit amet.”</p>
          {{-- Tampilan size desktop --}}
          <div class="hidden md:grid grid-rows-2 gap-4">
            <div class="flex justify-center gap-4">
              <img class="md:w-36 lg:w-40" src="{{ asset('img/merch1.png') }}" alt="">
              <img class="md:w-36 lg:w-40" src="{{ asset('img/merch2.png') }}" alt="">
              <img class="md:w-36 lg:w-40" src="{{ asset('img/merch3.png') }}" alt="">
            </div>
            <div class="flex justify-center gap-4">
              <img class="md:w-36 lg:w-56 object-contain" src="{{ asset('img/merch4.png') }}" alt="">
              <img class="md:w-36 lg:w-56 object-contain" src="{{ asset('img/merch5.png') }}" alt="">
            </div>
          </div>
          {{-- Tampil size mobile --}}
          <div id="merchSplide" class="container relative px-8 md:hidden splide">
            <div class="splide__track flex justify-center">
              <ul class="splide__list flex justify-center">
                <li class="splide__slide flex justify-center"><img class="w-36 flex justify-center" src="{{ asset('img/merch1.png') }}" alt="..." /></li>
                <li class="splide__slide flex justify-center"><img class="w-36 flex justify-center" src="{{ asset('img/merch2.png') }}" alt="..." /></li>
                <li class="splide__slide flex justify-center"><img class="w-36 flex justify-center" src="{{ asset('img/merch3.png') }}" alt="..." /></li>
                <li class="splide__slide flex justify-center"><img class="w-36 flex justify-center" src="{{ asset('img/merch4.png') }}" alt="..." /></li>
                <li class="splide__slide flex justify-center"><img class="w-36 flex justify-center" src="{{ asset('img/merch5.png') }}" alt="..." /></li>
              </ul>
            </div>
          </div>
          <a class="text-white text-md font-semibold bg-primary_HI py-3 px-4 rounded-xl transition duration-300 md:text-xl hover:bg-secondary_HI hover:scale-105" href="#">Order klik disini ya!</a>
        </div>
    </section>
    <!-- End Merchandise HI Section -->
